...
def lista_digitos_a_numero(digitos):
    ...
    numero = reduce(acumular_digitos, digitos)
...
def calcular_precio_con_descuento():
    ...
    Solicita el precio original y pregunta si el usuario tiene cupón de descuento.
    """
    ...
    try:
        ...
        # 2. Preguntar si tiene cupón de descuento
        tiene_cupon = input("\n¿Tienes un cupón de descuento? (sí/no): ").strip().lower()
        
        # 3 y 4. Si tiene cupón, solicitar el valor y aplicar descuento
        if tiene_cupon == "sí" or tiene_cupon == "si":
            # Solicitar valor del cupón
            descuento = float(input("Ingresa el valor del cupón de descuento: "))
            
            # Validar que el descuento sea válido (mayor a 0)
            if descuento > 0:
                # Aplicar descuento
                ...
                # 5. Mostrar precio final con descuento
                print("\n" + "=" * 40)
                ...
                print(f"Ahorro:             {min(descuento, precio_original):.2f} €")
                print("=" * 40)
                
            else:
                # Cupón no válido (menor o igual a 0)
                print("\n Error: El valor del cupón debe ser mayor a 0.")
                print(f"\nPrecio final sin descuento: {precio_original:.2f} €")
            ...
            print("=" * 40)
            print(f"Precio original:    {precio_original:.2f} €")
            print(f"Descuento aplicado: 0.00 €")
